...
<main class="brev-index">
	<header class="hero">
		...
		<p class="hero-lede">
			Achevé vers l'an 1257, le <em>Breviloquium</em> de saint Bonaventure offre, en sept parties, une
			vue d'ensemble de la foi catholique : de la Trinité jusqu'aux fins dernières, en passant par la
			création, le péché, l'Incarnation, la grâce et les sacrements.
		</p>
		{#if firstChapter}
			<p class="hero-cta">
