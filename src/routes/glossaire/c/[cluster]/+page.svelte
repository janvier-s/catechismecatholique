...
<svelte:head>
	<title>{data.cluster.label} · Glossaire · Catéchisme</title>
...
<main class="mx-auto max-w-reader px-6 py-10">
	...
	<header class="mb-8">
		<h1 class="font-heading text-3xl font-semibold mb-2">{data.cluster.label}</h1>
		<p class="text-muted text-[15px] leading-relaxed mb-3">{data.cluster.description}</p>
