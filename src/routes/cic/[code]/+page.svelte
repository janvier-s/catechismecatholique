<script lang="ts">
	...
	> = {
		'1983': {
			...
			lede: "Le code en vigueur dans l'Église latine — 1 752 canons répartis en sept livres, fruit de la révision voulue par le concile Vatican II."
		},
		'1917': {
			kicker: 'Codex Iuris Canonici · 1917',
			title: 'Code Pio-Benedictin',
			subtitle: 'Promulgué par Benoît XV le 27 mai 1917',
			lede: "Premier code unifié du droit de l'Église latine — 2 414 canons répartis en cinq livres, en vigueur jusqu'en 1983."
		}
	};
...
<main class="cic-index">
	<header class="hero">
		...
		<p class="hero-stats">
			...
			<span>{totalCanons.toLocaleString('fr-FR').replace(/[\u00a0\u202f]/g, ' ')} canons</span>
		</p>
	</header>
