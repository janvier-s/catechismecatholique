...
<MetaTags
	title="Enchiridion Symbolorum · Denzinger"
	description="Édition française de l'Enchiridion Symbolorum (Denzinger) : recueil canonique des symboles, définitions et déclarations magistérielles de l'Église catholique des origines à 1959."
...
<main class="dz-index">
	<header class="hero">
		...
		<h1 class="hero-title">
			<em class="hero-em-primary">Enchiridion Symbolorum</em><br /><span class="hero-em-secondary"
				>Denzinger</span
			>
		</h1>
		<p class="hero-lede">
		...
		<a class="hero-toc" href="/enchiridion/sommaire">Sommaire complet →</a>
	</header>

	<section class="parts" aria-label="Parties">
		{#each data.structure.parts as part (part.slug)}
			{@const firstUnit = part.units[0]}
			<a class="part-card" href="/enchiridion/{firstUnit?.slug ?? ''}">
