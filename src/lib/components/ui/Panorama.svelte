<script lang="ts">
	...
	// the card carries a meaningful preview instead of just its title.
...
<style>
	...
	/* Prologue: quieter title, no accent rule, less tail-space below */
	.pano-part.is-prologue .pano-banner {
		border-bottom: none;
